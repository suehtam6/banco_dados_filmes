...
const insertProfissionalNacionalidade = async function(dados) {
...
//Função para atualizar um profissional e nacionalidade
const updateProfissionalNacionalidade = async function(dados) {
...
//Função para selecionar todos os profissional e nacionalidade
const selectAllProfissionalNacionalidade = async function() {
    ...
    try {
        ...
        if (Array.isArray(result)) {
            return result[0] // Retorna somente o índice com a lista dos profissionais.
